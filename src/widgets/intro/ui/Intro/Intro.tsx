        ...
        <section className="intro">
            ...
            <div className="intro__content">
                ...
                <p className="intro__text">
                    Я — мастер спорта России по художественной гимнастике. В 2021 году я завершила обучение в
                ...
                <p className="intro__text">
                    Однако со временем я осознала, что моя настоящая страсть заключается в дизайне интерьеров. Этот
                    ...
                    идеи и решения в области дизайна стало для меня приоритетом.
                </p>
                <p className="intro__text">
                    Для дальнейшего развития своих навыков я решила обучиться в Московской школе дизайна (МШД), что
