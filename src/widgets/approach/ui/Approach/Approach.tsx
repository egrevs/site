    ...
    const approachItems = [
        {
            ...
            text: 'Осуществляем полный цикл работ: от планировочного решения до полной реализации дизайн-проекта. Рекомендуем проверенных специалистов для наиболее точной и качественной реализации. Даже удаленно контролируем подрядчиков и каждый этап работы.'
        },
        {
            number: '02',
